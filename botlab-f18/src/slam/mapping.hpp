...
public:
    ...
    */
    ...
    void breshenham(const int startGridX, const int startGridY, const int endGridX, const int endGridY, OccupancyGrid& map);
    void updateOdds(int x, int y, OccupancyGrid& map, int hitFlag);
    void breshenham2(int xStart, int yStart, int xEnd, int yEnd, OccupancyGrid& map);
private:
